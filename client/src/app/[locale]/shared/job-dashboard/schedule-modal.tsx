...
import { ActionIcon, AdvancedRadio, Button, Input, RadioGroup, Text, Textarea, Title } from 'rizzui';
    ...
    <div className="relative">
      ...
      <div className=" mx-auto flex max-w-md flex-col items-center gap-2.5 px-5 pb-7 pt-8 text-center md:px-7 md:pb-10 md:pt-12">
        ...
        <Text className="leading-relaxed text-gray-500 md:pt-0.5">
          By becoming a part of our platform, you are opening the door to a world of incredible opportunities:
        </Text>
      </div>
      <div className="space-y-5 px-5 pb-5 md:px-7 md:pb-7">
        ...
        <div>
          ...
          <div className="flex flex-col rounded-lg border border-gray-300 md:flex-row">
            ...
            <div className="w-full shrink-0 border-gray-300 md:w-72 md:border-s">
              <Title as="h4" className="px-5 pb-3 pt-2 text-base font-semibold text-gray-800 md:pt-5">
                Time
              </Title>
              <SimpleBar className="mb-5 h-[320px] px-5">
                <RadioGroup value={timeState} setValue={setTimeState} className="space-y-2 py-0.5">
        ...
        <Textarea label="Description" placeholder="What is this meeting about" textareaClassName="resize-none" />
      </div>
