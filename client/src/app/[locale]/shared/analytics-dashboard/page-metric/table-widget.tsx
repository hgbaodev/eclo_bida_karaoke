...
import { getColumns } from '@/app/[locale]/shared/analytics-dashboard/page-metric/columns';
...
export default function PageMetrics({ className, pageSize = 5 }: PageMetricsTypes) {
  ...
  const { isLoading, sortConfig, totalItems, tableData, currentPage, handleSort, handlePaginate } = useTable(
    pageMetricData,
    pageSize,
  );
  ...
  return (
    <div className={cn('rounded-xl border border-muted bg-gray-0 p-5 lg:p-7 dark:bg-gray-50', className)}>
