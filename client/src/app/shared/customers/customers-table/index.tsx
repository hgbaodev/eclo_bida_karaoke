...
import { getColumns } from '@/app/shared/customers/customers-table/columns';
import { useSelector } from 'react-redux';
import { RootState } from '@/store/types';
import { dispatch } from '@/store';
import { getCustomers, setPage, setPageSize } from '@/store/slices/customerSlice';
import { useModal } from '../../modal-views/use-modal';
const FilterElement = dynamic(() => import('@/app/shared/customers/customers-table/filter-element'), {
  ssr: false,
});
